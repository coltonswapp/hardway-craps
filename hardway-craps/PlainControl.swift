...
class PlainControl: UIControl, BetDropTarget {
    ...
    @objc private func handleTap() {
        ...
        guard let getValue = getSelectedChipValue else {
            print("handleTap called but getSelectedChipValue is nil")
            return
        }
        ...
        print("handleTap called, selectedChipValue: \(value)")
...
//    }
    ...
    func addBet(_ amount: Int) {
        print("PlainControl.addBet called with amount: \(amount)")
        betView.addToBet(amount)
        print("betView.amount is now: \(betView.amount), isHidden: \(betView.isHidden)")
    ...
    func addBetWithAnimation(_ amount: Int) {
        print("PlainControl.addBetWithAnimation called with amount: \(amount)")
        betView.addToBet(amount)
