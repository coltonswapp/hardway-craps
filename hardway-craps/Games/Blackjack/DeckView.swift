...
class DeckView: UIView {
    ...
    private func setupView() {
        ...
        NSLayoutConstraint.activate([
            ...
            cardCountLabel.widthAnchor.constraint(greaterThanOrEqualToConstant: 100),
    ...
    func updateCardCountLabel(runningCount: Int, trueCount: Int) {
        let runningPrefix = runningCount > 0 ? "+" : ""
        let truePrefix = trueCount > 0 ? "+" : ""
        cardCountLabel.text = "\(runningPrefix)\(runningCount)  \(truePrefix)\(trueCount)"
    }
