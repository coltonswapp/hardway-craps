...
class MultiplayerBlackjackViewController: BaseGameplayViewController, UIScrollViewDelegate {
    ...
    private func setupSeatsContainer() {
        ...
        NSLayoutConstraint.activate([
            ...
            seatsContainerView.bottomAnchor.constraint(equalTo: bottomBar.topAnchor, constant: -8),
    ...
    private func setupActionButtons() {
        ...
        NSLayoutConstraint.activate([
            ...
            nextHandButton.bottomAnchor.constraint(equalTo: bottomBar.bottomAnchor),
            ...
            continueButton.bottomAnchor.constraint(equalTo: bottomBar.bottomAnchor),
