...
//        iv.backgroundColor = .red.withAlphaComponent(0.5)
    ...
    private func setupView() {
        ...
        // Load chip image with selected color
        let chipColor = UserDefaults.standard.string(forKey: "ChipColor") ?? "cyan"
        imageView.image = UIImage(named: "hardway-chip-\(value)-\(chipColor)")
